...
void main() {
  ...
  fragColor = swAnimatedLoopNeon(position, vec4(0.0), vec4(0.0, 0.0, uSize.x, uSize.y), uTime, uSpeed, uLineWidth, uLines, uSpacing, uChannelOffset, uPatternMod, uRotation, uScale, uCenter, uShape, uPetals, uAngularLobes, uAngularAmount, uAngularSpeed, uColor1, uColor2, uColor3, uBackground);
}
